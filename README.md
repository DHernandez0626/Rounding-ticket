...
Individual entries are being saved as their own ticket object and will save what ever information you have in the entry field and attaches it to that name. Currently there is no way to edit the entry after adding will be working on that in the next upcoming version
